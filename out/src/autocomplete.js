...
function provideCompletionItems(document, position) {
  ...
  function createMeterCompletionItems() {
    ...
    return meterTypes.map(
      (type) => new vscode.CompletionItem(type, vscode.CompletionItemKind.Value)
    );
  }
  ...
  if (lineText.startsWith("graphstart=") && !hasAssignedValue("graphstart=")) {
  ...
  if (
    ...
    (lineText.startsWith("antialias=") && !hasAssignedValue("antialias=")) ||
    (lineText.startsWith("greyscale=") && !hasAssignedValue("greyscale=")) ||
    (lineText.startsWith("autoscale=") && !hasAssignedValue("autoscale=")) ||
    ...
    (lineText.startsWith("startshift=") && !hasAssignedValue("startshift=")) ||
    ...
    (lineText.startsWith("percentual=") && !hasAssignedValue("percentual=")) ||
    (lineText.startsWith("draggable=") && !hasAssignedValue("draggable=")) ||
    (lineText.startsWith("snapedges=") && !hasAssignedValue("snapedges=")) ||
    ...
    (lineText.startsWith("blur=") && !hasAssignedValue("blur=")) ||
  ...
  if (
    ...
    (lineText.startsWith("solidcolor=") && !hasAssignedValue("solidcolor=")) ||
    (lineText.startsWith("fontcolor=") && !hasAssignedValue("fontcolor=")) ||
    (lineText.startsWith("bothcolor=") && !hasAssignedValue("bothcolor=")) ||
    ...
    (lineText.startsWith("linecolor=") && !hasAssignedValue("linecolor=")) ||
    (lineText.startsWith("imagetint=") && !hasAssignedValue("imagetint=")) ||
  ...
  function createNumericCompletionItems(start, end, step = 1) {
    ...
    for (let i = start; i <= end; i += step) {
      items.push(
        new vscode.CompletionItem(i.toString(), vscode.CompletionItemKind.Value)
      );
    }
    return items;
  }

  if (lineText.startsWith("fontWeight=") && !hasAssignedValue("fontWeight=")) {
    return createNumericCompletionItems(100, 900, 100);
  }

  if (lineText.startsWith("update=") && !hasAssignedValue("update=")) {
  ...
  if (lineText.startsWith("imagealpha=") && !hasAssignedValue("imagealpha=")) {
  ...
  if (lineText.startsWith("clipstring=") && !hasAssignedValue("clipstring=")) {
  ...
  if (lineText.startsWith("alphavalue=") && !hasAssignedValue("alphavalue=")) {
    return createNumericCompletionItems(0, 250, 50);
  }

  if (lineText.startsWith("loadorder=") && !hasAssignedValue("loadorder=")) {
  ...
  if (lineText.startsWith("blurregion=") && !hasAssignedValue("blurregion=")) {
    const item0 = new vscode.CompletionItem(
      "0",
      vscode.CompletionItemKind.Value
    );
    item0.documentation = "(Region is disabled) : No blur region is applied.";
  ...
  if (lineText.startsWith("beveltype=") && !hasAssignedValue("beveltype=")) {
    const item0 = new vscode.CompletionItem(
      "0",
      vscode.CompletionItemKind.Value
    );
    item0.documentation = "(No bevel) : No bevel effect is applied.";
  ...
  if (lineText.startsWith("stringcase=") && !hasAssignedValue("stringcase=")) {
    return [
  ...
  if (
    ...
    return [
      ...
      new vscode.CompletionItem("BoldItalic", vscode.CompletionItemKind.Value),
    ];
  }
  ...
  if (
    ...
    return [
      new vscode.CompletionItem("None", vscode.CompletionItemKind.Value),
      new vscode.CompletionItem("Shadow", vscode.CompletionItemKind.Value),
  ...
  function createFontFaceCompletionItems(fonts) {
    return fonts.map(
      (font) => new vscode.CompletionItem(font, vscode.CompletionItemKind.Value)
    );
  }

  if (lineText.startsWith("fontface=") && !hasAssignedValue("fontface=")) {
    const fontList = [
      "Arial",
      "Calibri",
      "Tahoma",
  ...
  if (
    ...
    item0.documentation = "(Do Nothing - default) : No action is taken.";
  ...
  if (lineText.startsWith("onhover=") && !hasAssignedValue("onhover=")) {
    const item0 = new vscode.CompletionItem(
      "0",
      vscode.CompletionItemKind.Value
    );
